...
public class CalenderViewAdapter extends ArrayAdapter<DayPopUpListFragment> {
    Context context;
    int resource;
    ArrayList<DayPopUpListFragment> subjects = null;
    public CalenderViewAdapter(Context context, int resource, ArrayList<DayPopUpListFragment> subjects){
